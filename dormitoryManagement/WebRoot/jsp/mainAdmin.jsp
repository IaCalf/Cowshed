...
<title>宿舍管理系统</title>
<link href="${pageContext.request.contextPath}/jsp/style/dorm.css" rel="stylesheet">
...
<link href="${pageContext.request.contextPath}/jsp/bootstrap-datetimepicker-master/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/bootstrap-datetimepicker-master/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/bootstrap-datetimepicker-master/js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		...
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${role.username }</font></div>
	</div>
</div>
