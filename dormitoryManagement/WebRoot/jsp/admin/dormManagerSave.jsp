...
<div class="data_list">
		...
		<form <c:choose><c:when test="${dormManager!=null }">action="update"</c:when><c:otherwise>action="add"</c:otherwise></c:choose> method="post" onsubmit="return checkForm()">
			<div class="data_form" >
				<input type="hidden" id="dormManagerId" name="dormmanid" value="${dormManager.dormmanid }"/>
					<table align="center">
						<tr>
